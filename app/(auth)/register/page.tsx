...
export default function RegisterPage() {
  ...
  useEffect(() => {
    ...
    if (errorParam === "auth_error") {
      setErrors({ general: t("auth.errors.auth_error") });
    } else if (errorParam === "callback_error") {
      setErrors({ general: t("auth.errors.callback_error") });
    }
  }, [searchParams, t]);
  ...
  const validateForm = () => {
    ...
    if (formData.password !== formData.confirmPassword) {
      newErrors.confirmPassword = t("auth.errors.passwords_no_match");
    }
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setErrors({ general: t("auth.errors.google_error") });
      setIsGoogleLoading(false);
    }
  };
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-6 backdrop-blur-sm">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {isGoogleLoading
                  ? t("auth.register.google_loading")
